# -*- coding: utf-8 -*-
"""
Created on Sun May 11 19:33:40 2025
...
os.chdir('C:/Users/lenovo/Desktop/github/code_new/')
# In[读取数据]
# 导入含有预处理函数的模块（假设已保存为 preprocessing.py）
from preprocessing import preprocess_car1, preprocess_car2, preprocess_car3, preprocess_car4


# 创建预处理函数映射字典
preprocessing_functions = {
    'car1': preprocess_car1,
    'car2': preprocess_car2,
    'car3': preprocess_car3,
    'car4': preprocess_car4
}
# 将file_paths改为字典格式
file_paths = {
    'car1': 'C:/Users/lenovo/Desktop/github/data/car1.csv',
    'car2': 'C:/Users/lenovo/Desktop/github/data/car2.csv',
    'car3': 'C:/Users/lenovo/Desktop/github/data/car3.csv',
    'car4': 'C:/Users/lenovo/Desktop/github/data/car4.csv'
}
